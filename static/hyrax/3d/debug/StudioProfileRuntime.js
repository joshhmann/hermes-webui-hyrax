import { adaptMotionJson } from '/api/hyrax/3d/calibration-studio/adapters/soma-motion-json.js?v=4'
import {
  extractThreeVrmAvatarRigVariants,
} from '/api/hyrax/3d/calibration-studio/adapters/three-vrm-avatar-rig.js?v=3'
import { indexThreeRigObjects } from '/api/hyrax/3d/calibration-studio/adapters/three-avatar-rig.js?v=6'
import {
  applyPoseToThreeObject,
  createRetargetSession,
} from '/api/hyrax/3d/calibration-studio/core/retarget.js?v=10'
import { sha256Signature } from '/api/hyrax/3d/calibration-studio/core/sha256.js?v=1'
