...
def test_security_helper_sends_enforcing_csp_with_hardening_directives(monkeypatch):
    ...
    assert "connect-src 'self' blob: http://127.0.0.1:* http://localhost:* http://ipc.localhost https://127.0.0.1:* https://localhost:* ws://127.0.0.1:* ws://localhost:* https://cdn.jsdelivr.net" in policy
